...
{
	public class ReconSattelite : IProjectile
	{
		...
		public ReconSattelite(Player firedBy, WeaponInfo weapon, World world, WPos launchPos, CPos location, string effect, string sequence, string palette, int delay)
		{
