...
{
	class ReconSattelitePowerInfo : SupportPowerInfo, IRulesetLoaded
	{
		[ActorReference]
		...
		public readonly string Weapon = "ReconSattelite";
		...
		public override object Create(ActorInitializer init) { return new ReconSattelitePower(init.Self, this); }
		...
		// Copied from common traits RevealsShroud.cs
		[Desc("Can this actor reveal shroud generated by the GeneratesShroud trait?")]
		public readonly bool RevealGeneratedShroud = true;
	}

	class ReconSattelitePower : SupportPower
	{
		readonly ReconSattelitePowerInfo info;

		public ReconSattelitePower(Actor self, ReconSattelitePowerInfo info)
			: base(self, info)
		{
			this.info = info;
		}
		...
		{
		     // This should reveal the map
               //p.Shroud.AddSource(this, type, new PPos(1,1));
			...
			self.World.AddFrameEndTask(w =>
			{
				...
				w.Add(new ReconSattelite(self.Owner, info.WeaponInfo, w, self.CenterPosition, targetLocation,
